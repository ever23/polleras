...
use Cc\Mvc\TablaModel;
 /*
 * Clase modelo para la tabla venta_huevos
 *
 */
class  venta_huevos extends TablaModel
{

    /**
    * Este metod sera llamado cuando se este por crear la tabla venta_huevos
    * Ejemplo del codigo 
    * <code>
    ...
    */
    ...
    /**
    * Este metod sera llamado cuando se inicialize la tabla venta_huevos
    * Ejemplo del codigo 
    * <code>
    * <?php //Ejemplo del codigo
