...
use Cc\Mvc\TablaModel;
 /*
 * Clase modelo para la tabla compra_alimentos
 *
 */
class  compra_alimentos extends TablaModel
{

    /**
    * Este metod sera llamado cuando se este por crear la tabla compra_alimentos
    * Ejemplo del codigo 
    * <code>
    ...
    */
    ...
    /**
    * Este metod sera llamado cuando se inicialize la tabla compra_alimentos
    * Ejemplo del codigo 
    * <code>
    * <?php //Ejemplo del codigo
