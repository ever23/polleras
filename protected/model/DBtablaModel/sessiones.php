...
use Cc\Mvc\TablaModel;
 /*
 * Clase modelo para la tabla sessiones
 *
 */
class  sessiones extends TablaModel
{

    /**
    * Este metod sera llamado cuando se este por crear la tabla sessiones
    * Ejemplo del codigo 
    * <code>
    ...
    */
    ...
    /**
    * Este metod sera llamado cuando se inicialize la tabla sessiones
    * Ejemplo del codigo 
    * <code>
    * <?php //Ejemplo del codigo
