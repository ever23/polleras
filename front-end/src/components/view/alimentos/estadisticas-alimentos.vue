        ...
        methods:
        {
          ...
          ejecutar()
            { 
              ...
              if(this.Ccompras)
              {
                this.Ccompras.destroy();
                this.Cconsumos.destroy();
              }
               this.Ccompras= new Chart(this.$refs.consumo.getContext("2d")).Line({
               ...
               this.Cconsumos= new Chart(this.$refs.compra.getContext("2d")).Line({
